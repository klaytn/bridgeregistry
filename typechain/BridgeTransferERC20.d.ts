...
interface BridgeTransferERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class BridgeTransferERC20 extends BaseContract {
  ...
  interface: BridgeTransferERC20Interface;
