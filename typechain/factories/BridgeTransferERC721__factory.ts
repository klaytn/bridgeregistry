...
import type {
  ...
  BridgeTransferERC721Interface,
} from "../BridgeTransferERC721";
...
export class BridgeTransferERC721__factory {
  static readonly abi = _abi;
  static createInterface(): BridgeTransferERC721Interface {
    return new utils.Interface(_abi) as BridgeTransferERC721Interface;
  }
  static connect(
    address: string,
