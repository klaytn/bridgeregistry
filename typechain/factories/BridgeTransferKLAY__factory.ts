...
import type {
  BridgeTransferKLAY,
  BridgeTransferKLAYInterface,
} from "../BridgeTransferKLAY";
...
export class BridgeTransferKLAY__factory {
  static readonly abi = _abi;
  static createInterface(): BridgeTransferKLAYInterface {
    return new utils.Interface(_abi) as BridgeTransferKLAYInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BridgeTransferKLAY {
    return new Contract(address, _abi, signerOrProvider) as BridgeTransferKLAY;
  }
}
