...
export class BridgeTransfer__factory {
  static readonly abi = _abi;
  static createInterface(): BridgeTransferInterface {
    return new utils.Interface(_abi) as BridgeTransferInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BridgeTransfer {
    return new Contract(address, _abi, signerOrProvider) as BridgeTransfer;
  }
}
